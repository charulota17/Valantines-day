window.addEventListener('load', () => {
    ...
    // Call textAnim and smallHeartAnim functions when the mouse is over the card
    const card = document.querySelector('.card');
    card.addEventListener('mouseover', () => {
      let additionalContent = document.createElement('div');
    additionalContent.id = 'dynamicContent';  
    ...
    <div class="drawBox">
      ...
      document.getElementById('additionalContent').appendChild(additionalContent);
      const total = 13;
    ...
    if (container) {
        ...
        console.error("Container with class 'smallHearts' not found in the DOM.");
    }
